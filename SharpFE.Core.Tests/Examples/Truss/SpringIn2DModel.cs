...
namespace SharpFE.Examples
{
    ...
    public class SpringIn2DModel
    {
        ...
        public void SpringInXAxis()
        {
            ...
            FiniteElementNode node2 = model.NodeFactory.CreateForTruss(1, 0); // create a second node at a distance 1 metre along the X axis.
        ...
        public void SpringAt60DegreesInXYPlane()
        {
            ...
            FiniteElementNode node2 = model.NodeFactory.CreateForTruss(1, 1.73205); // create a second node at a distance 1 metre along the X axis and 1.73 metres along the Y axis (giving an angle of 60 degrees from x-axis).
