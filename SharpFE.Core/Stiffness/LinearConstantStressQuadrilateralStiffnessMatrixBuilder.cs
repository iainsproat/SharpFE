...
namespace SharpFE.Stiffness
{
	...
	/// </summary>
	public class LinearConstantStressQuadrilateralStiffnessMatrixBuilder : StiffnessMatrixBuilder
	{
		public LinearConstantStressQuadrilateralStiffnessMatrixBuilder(FiniteElement element)
			:base(element)
		{
			// empty
		}
		...
		public override KeyedRowColumnMatrix<DegreeOfFreedom, NodalDegreeOfFreedom> GetShapeFunctionVector(FiniteElementNode location)
		{
			...
			LinearConstantStressQuadrilateral quad = this.CastElementTo<LinearConstantStressQuadrilateral>();
...
//			B.At(Strain.ShearStrainXY, new NodalDegreeOfFreedom(node2, DegreeOfFreedom.Y), constant * (node0.OriginalY - node1.OriginalY));
		...
		{
			LinearConstantStressQuadrilateral triangle = this.CastElementTo<LinearConstantStressQuadrilateral>();
			double elementVolume = triangle.Thickness * triangle.Area; //FIXME
