using System;
using MathNet.Numerics.LinearAlgebra.Keyed.Generic;
using NUnit.Framework;

namespace MathNet.Numerics.UnitTests.LinearAlgebraTests.Keyed
{
    partial class KeyedMatrixStructureTheory<T>
    {
        [Theory, Timeout(200)]
        public void CanGetFieldsByIndex(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetRow(KeyedMatrix<T> matrix)
        {
            // First Row
        ...
        [Theory, Timeout(200)]
        public void CanGetRowIntoResult(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetRowWithRange(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetRowWithRangeIntoResult(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetColumn(KeyedMatrix<T> matrix)
        {
            // First Column
        ...
        [Theory, Timeout(200)]
        public void CanGetColumnIntoResult(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetColumnWithRange(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetColumnWithRangeIntoResult(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanSetRow(KeyedMatrix<T> matrix)
        {
            // First Row
            var m = matrix.Clone();
            ...
            // Invalid Rows
            Assert.That(() => matrix.SetRow(0, default(KeyedVector<T>)), Throws.InstanceOf<ArgumentNullException>());
        ...
        [Theory, Timeout(200)]
        public void CanSetRowArray(KeyedMatrix<T> matrix)
        {
            // First Row
            var m = matrix.Clone();
        ...
        [Theory, Timeout(200)]
        public void CanSetColumn(KeyedMatrix<T> matrix)
        {
            // First Column
            var m = matrix.Clone();
            ...
            // Invalid Rows
            Assert.That(() => matrix.SetColumn(0, default(KeyedVector<T>)), Throws.InstanceOf<ArgumentNullException>());
        ...
        [Theory, Timeout(200)]
        public void CanSetColumnArray(KeyedMatrix<T> matrix)
        {
            // First Column
            var m = matrix.Clone();
        ...
        [Theory, Timeout(200)]
        public void CanGetUpperTriangle(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetUpperTriangleIntoResult(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetLowerTriangle(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetLowerTriangleIntoResult(KeyedMatrix<T> matrix)
        {
            var dense = CreateDenseZero(matrix.RowCount, matrix.ColumnCount);
        ...
        [Theory, Timeout(200)]
        public void CanGetStrictlyUpperTriangle(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetStrictlyUpperTriangleIntoResult(KeyedMatrix<T> matrix)
        {
            var dense = CreateDenseZero(matrix.RowCount, matrix.ColumnCount);
        ...
        [Theory, Timeout(200)]
        public void CanGetStrictlyLowerTriangle(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanGetStrictlyLowerTriangleIntoResult(KeyedMatrix<T> matrix)
        {
            var dense = CreateDenseZero(matrix.RowCount, matrix.ColumnCount);
        ...
        [Theory, Timeout(200)]
        public void CanGetDiagonal(KeyedMatrix<T> matrix)
        {
        ...
        [Theory, Timeout(200)]
        public void CanSetDiagonal(KeyedMatrix<T> matrix)
        {
            var m = matrix.Clone();
            ...
            // Invalid
            Assert.That(() => matrix.SetDiagonal(default(KeyedVector<T>)), Throws.InstanceOf<ArgumentNullException>());
            Assert.That(() => matrix.SetDiagonal(CreateVectorZero(Math.Min(matrix.RowCount, matrix.ColumnCount) - 1)), Throws.ArgumentException);
            Assert.That(() => matrix.SetDiagonal(CreateVectorZero(Math.Min(matrix.RowCount, matrix.ColumnCount) + 1)), Throws.ArgumentException);
        }

        [Theory, Timeout(200)]
        public void CanSetDiagonalArray(KeyedMatrix<T> matrix)
        {
            var m = matrix.Clone();
        ...
        [Theory, Timeout(200)]
        public void CanGetSubmatrix(KeyedMatrix<T> matrix)
        {
            // Top Left Corner 2x2
        ...
        [Theory, Timeout(200)]
        public void CanSetSubmatrix(KeyedMatrix<T> matrix)
        {
            // Top Left Corner 2x2
            ...
            // Invalid
            m = matrix.Clone();
            Assert.That(() => m.SetSubMatrix(0, 1, 0, 1, default(KeyedMatrix<T>)), Throws.InstanceOf<ArgumentNullException>());
