...
{
    [Serializable]
    public class SparseKeyedCompressedRowMatrixStorage<T> : KeyedMatrixStorage<T>
        where T : struct, IEquatable<T>, IFormattable
    {
        ...
        internal SparseKeyedCompressedRowMatrixStorage(int rows, int columns, T zero = default(T))
            : base(rows, columns)
        {
            _zero = zero;
        ...
        public override bool Equals(KeyedMatrixStorage<T> other)
        {
            ...
            var sparse = other as SparseKeyedCompressedRowMatrixStorage<T>;
            if (sparse == null)
            {
        ...
        void CopyToUnchecked(SparseKeyedCompressedRowMatrixStorage<T> target)
        {
